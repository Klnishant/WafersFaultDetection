...
class PredictionPipelineConfig():
    ...
    prediction_file_name:str='predictionfile.csv'
...
class PredictionPipeline():
    ...
    def save_input_files(self)->str:
        try:
            ...
            pred_file_path=os.path.join('artifacts',input_csv_file.filename)
    ...
    def predict(self, features):
            try:
                ...
                preprocessor = load_object(file_path=self.prediction_pipeline_config.preprocessor_file_path)
                ...
                logging.info('Prediction dataframe created')

                return preds

            except Exception as e:
                logging.info('Error occured in predicting data')
                raise CustomException(e, sys)
